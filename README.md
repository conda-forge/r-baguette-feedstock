...
Once the `conda-forge` channel has been enabled, `r-baguette` can be installed with:

```
conda install r-baguette
```

It is possible to list all of the versions of `r-baguette` available on your platform with:
